...
description: |
  A quick analysis about the noticeable trends in the history of basketball...
site: distill::distill_website
author:
  - name: Abhay Paidipalli
    url: 
date: 'June 23rd 2021 (IN PROGRESS)'
...
Moving on, we should also take a look at the reach basketball has on the entire globe. This is important since basketball was only created in 1891, which is pretty late considering other sports like soccer have been around in some fashion since as far back as 2500 BC. <br>

Nonetheless, the visualization below allows us to judge this by showing us where the players of the NBA have come from.
...
Other important statistics for basketball analysis as a whole involve categories such as assists, steals, and blocks, as depicted in the graph above. Although there have been a few minor trends in these areas over time, there isn't really anything too important we need to note down here. <br>
